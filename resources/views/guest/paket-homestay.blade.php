    ...
    <div class="container-xxl py-5">
        <div class="row g-4">
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-12">
                    <div class="text-start mx-auto mb-2 wow slideInLeft" data-wow-delay="0.1s">
                        <h1 class="">Layanan Tambahan</h1>
                        <p class="text-white-500">Nikmati Liburan Tanpa Batas! Gabungkan Penginapan Anda dengan
                            Layanan Tambahan yang Tak Terlupakan! Pilihlah dari Beragam Pilihan Wisata yang Kami
                            Tawarkan dan Tambahkan Ke dalam Paket Homestay Anda. Rasakan Sensasi Baru Liburan yang
                            Menakjubkan dengan Layanan Makanan, Oleh-Oleh, dan Lainnya yang Dapat Anda Nikmati di Tempat
                            Anda Menginap. Bayar Semuanya Saat Check-out!</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item rounded overflow-hidden">
                    ...
                    <div class="text-center p-2 ">
                        <h5 class="fw-bold mb-1">Kopi Kamojang</h5>
