    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">
                                    <div class="row justify-content-start px-4">
                                        <div class="col-sm-10">
                                            <button type="button" class="btn btn-primary updateTransaksiButton"
                                                data-bs-toggle="modal" data-bs-target="#updateTransaksiModal"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <table class="table table-bordered ">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td> <strong>Status Transfer Pemilik</strong>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <div class="col-sm-10">
                                                                                <select id="defaultSelect"
                                                                                    class="form-select">
                                                                                    <option>Pilih Status</option>
                                                                                    <option value="1">Belom
                                                                                    </option>
                                                                                    <option value="2">Sudah
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </td>
                ...
                <div class="modal fade" id="updateTransaksiModal" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="updateTransaksiButton">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
