                ...
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Total Belum Transfer Ke Pemilik</span>
                            <h3 class="card-title mb-2">Rp {{ number_format($sum_biaya_admin_belum - $sum_biaya_admin, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                ...
                <div class="col-lg-4 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Total Sudah Transfer Ke Pemilik</span>
                            <h3 class="card-title mb-2"> Rp {{ number_format($sum_biaya_admin_sudah - $sum_biaya_admin, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered mb-4">
                    <thead>
                        <tr>
                            ...
                            <th>Checkout</th>
                            <th>Total Inap</th>
                            <th>Total Yang Harus Di transfer</th>
                    ...
                    <tbody>
                        @foreach ($transaksi as $transaksis)
                            <tr>
                                ...
                                <td>Rp. {{ number_format($transaksis->total_harga - $transaksis->biaya_admin, 0, ',', '.'); }}</td>
                            ...
                            <div class="row justify-content-start px-4">
                                <div class="col-sm-10">
                                    <button type="button" class="btn btn-primary updateTransaksiHistoryButton" data-bs-toggle="modal"
                                        data-bs-target="#updateTransaksiHistoryModal"
                                        ...
                                        data-status_transfer_pemilik="{{ $transaksis->status_transfer_pemilik }}">
                                        Ubah
                                    </button>
                                </div>
                            </div>
          ...
          <!-- Modal for updating transaksi -->
                <div class="modal fade" id="updateTransaksiHistoryModal" tabindex="-1" aria-labelledby="updateTransaksiModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                @csrf
                                    <div class="mb-3">
                                    <label for="status_transfer_pemilik" class="form-label">STATUS TRANSFER PEMILIK	</label>
                                        <select class="form-select" id="status_transfer_pemilik" name="status_transfer_pemilik">
