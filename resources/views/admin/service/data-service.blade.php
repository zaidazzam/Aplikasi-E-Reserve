            ...
            <div class="col-md-4 col-xl-12">
                <div class="d-flex justify-content-between">
                                    ...
                                    <form id="imageService" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col mb-3">
                                                ...
                                                <input class="form-control" type="text" placeholder="Nama Service"
                                                    id="label_file" name="nama_service_tambahan" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#addServiceButton">
                        Tambah Service
                    </button>
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">
                                    <div class="row justify-content-start px-4">
                                        <div class="col-12">
                                            <button class="btn btn-danger delete-pengeluaran"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="updateTransaksiHistoryButton">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
